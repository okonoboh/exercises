...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%2.5.6%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \item[2.5.6]   Use the given lattices to help find the centralizers of every
      ...
      \begin{enumerate}
         ...
         \item $$
                  \begin{tabular}{@{}|c|c|@{}} \hline
                     Element(s) in $S_3$ & Centralizer \\ \hline
                     1 & $S_3$ \\ \hline
                     (1 2) & $\cyc{(1\;2)}$ \\ \hline
                     (1 3) & $\cyc{(1\;3)}$ \\ \hline
                     (2 3) & $\cyc{(2\;3)}$ \\ \hline
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%2.5.7%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \item[2.5.7]   Find the center of $D_{16}$.
      ...
      are in all the centralizers of the elements of $D_{16}$. Thus
      $Z(D_{16}) = \cyc{r_4}$.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%2.5.8%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \item[2.5.8]   In each of the following groups find the normalizer of each
      ...
      \begin{enumerate}
         \item Clearly $N_{\{1\}}(S_3) = S_3$. Now we know, by Exercise 2.2.6
               (a), that every subgroup is contained in its normalizer. A simple
               calculation will show us that (1 3) does not normalize 
               $\cyc{(1\;2)}$ and $\cyc{(1\;2\;3)}$, and (1 2) does not
               normalize $\cyc{(1\;3)}$; thus none of the normalizers of the
               nontrivial proper subgroups of $S_3$ is equal to $S_3$.
               $$
                  \begin{tabular}{@{}|c|c|@{}} \hline
                     Subgroup in $S_3$ & Normalizer \\ \hline
                     1, $S_3$ & $S_3$ \\ \hline
                     ($\cyc{(1\;2)}$ & $\cyc{(1\;2)}$ \\ \hline
                     $\cyc{(1\;3)}$ & $\cyc{(1\;3)}$ \\ \hline
                     $\cyc{(2\;3)}$ & $\cyc{(2\;3)}$ \\ \hline
                     $\cyc{(1\;2\;3)}$ & $\cyc{(1\;2\;3)}$ \\ \hline
                  \end{tabular}
               $$ 
      \end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%2.5.9%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
