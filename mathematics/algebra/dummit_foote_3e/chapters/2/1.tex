...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%2.1.6%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \item[2.1.6]   Let $G$ be an abelian group. Prove that
      ...
      \textbf{Example.} Let
      $$A = \left(\begin{tabular}{@{}rr@{}}
         0 & 1 \\ $-1$ & $-1$
        \end{tabular}\right),
        B = \left(\begin{tabular}{@{}cr@{}}
         0 & $-1$ \\ 1 & 0
        \end{tabular}\right) \in GL_2(\R).$$
      The order of $A$ is 3, and the order of $B$ is 4, but $AB$ is not of
      finite order; indeed, we have that
      $$(AB)^n = \left(\begin{tabular}{@{}cc@{}}
         1 & $n$ \\ 0 & 1
        \end{tabular}\right), \qquad \text{for each }n \in \Z.$$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%2.1.7%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \item[2.1.7]   Fix some $n \in \Z$ with $n > 1$. Find the torsion subgroup
      ...
      order together with the identity. We have (1, 0), ($-1$, 0) $\in H$, but
