...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%3.1.23%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \item[3.1.23]  Prove that the join of any nonempty collection of normal
      ...
      $n \in \Z^+$, $\epsilon_i \in \Z$, and $h_i \in H$, for each $i \in I$.
      Now
      \begin{align*}
         ghg^{-1} &= g{h_1}^{\epsilon_1}{h_2}^{\epsilon_2} \cdots
                     {h_n}^{\epsilon_n}g^{-1} \\
           &= g{h_1}^{\epsilon_1}1{h_2}^{\epsilon_2}1 \cdots
                     1{h_n}^{\epsilon_n}g^{-1} \\
           &= g{h_1}^{\epsilon_1}g^{-1}g{h_2}^{\epsilon_2}g^{-1}g \cdots
                     g^{-1}g{h_n}^{\epsilon_n}g^{-1} \\
           &= (g{h_1}^{\epsilon_1}g^{-1})(g{h_2}^{\epsilon_2}g^{-1})\cdots
                     (g{h_n}^{\epsilon_n}g^{-1}).
      \end{align*}
      Consider $g{h_r}^{\epsilon_r}g^{-1}$, where $1 \le r \le n$. Since
      $h_r \in H$, it follows that $h_r \in H_k$ for some $k \in I$; and since
      $H_k$ is normal in $G$, it follows that
      $g{h_r}^{\epsilon_r}g^{-1} \in H_k$, so that
      $g{h_r}^{\epsilon_r}g^{-1} \in H$. Hence
      $g{h_i}^{\epsilon_i}g^{-1} \in H$, for each $i \in \{1, \ldots, n\}$. So
      it follows that $ghg^{-1} \in H$, so that $ghg^{-1} \in \cyc{H}$. That is,
      $\cyc{H} \trianglelefteq G$ by Theorem 6(5). \qed
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%3.1.24%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%3.1.28%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \item[3.1.28]  Let $N$ be a \textit{finite} subgroup of a group $G$ and
      ...
      \begin{align*}
         gng^{-1} &= g({s_1}^{\epsilon_1}{s_2}^{\epsilon_2} \cdots
            {s_m}^{\epsilon_m})g^{-1} \\
            &= g{s_1}^{\epsilon_1}g^{-1}\cdot g{s_2}^{\epsilon_2}g^{-1} \cdots
            g{s_m}^{\epsilon_m}g^{-1}. &[\text{Exercise 26(a)}]
      \end{align*}
      By assumption $g{s_i}^{\epsilon_i}g^{-1} \in N$ for each $1 \le i \le m$,
      so that $gng^{-1} \in N$ by closure of $N$. That is,
      $gNg^{-1} \subseteq N$. Conclude by Exercise 27 that $gNg^{-1} = N$. \qed
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%3.1.29%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
