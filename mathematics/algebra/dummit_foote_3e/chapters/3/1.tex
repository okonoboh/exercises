   ...
   \item[3.1.23]  Prove that the join of any nonempty collection of normal
      ...
      \begin{align*}
         ghg^{-1} &= g{h_1}^{\epsilon_1}h_2^{\epsilon_2} \cdots
                     h_n^{\epsilon_n}g^{-1} \\
           &= g{h_1}^{\epsilon_1}1h_2^{\epsilon_2}1 \cdots
                     1h_n^{\epsilon_n}g^{-1} \\
           &= g{h_1}^{\epsilon_1}g^{-1}gh_2^{\epsilon_2}g^{-1}g \cdots
                     g^{-1}gh_n^{\epsilon_n}g^{-1} \\
           &= (g{h_1}^{\epsilon_1}g^{-1})(gh_2^{\epsilon_2}g^{-1})\cdots
                     (gh_n^{\epsilon_n}g^{-1}).
      \end{align*}
