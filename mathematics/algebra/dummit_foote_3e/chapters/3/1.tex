...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%3.1.1%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \item[3.1.1]   Let $\varphi : G \rightarrow H$ be a homomorphism and let $E$
      ...
      \textbf{Proof.} Since $\varphi(1) = 1 \in E$ (Proposition 1 (1) (Pg. 75)),
      it follows that $1 \in \varphi^{-1}(E)$, and hence, $\varphi^{-1}(E)$ is 
      not empty. Now let $x, y \in \varphi^{-1}(E)$. That is,
      $\varphi(x), \varphi(y) \in E$. Since $E$ is closed, it follows that
      $\varphi(x)\varphi(y) \in E$. Thus by the homomorphic property of
      $\varphi$, it follows that $\varphi(xy) = \varphi(x)\varphi(y) \in E$, so
      that $xy \in \varphi^{-1}(E)$. Hence $\varphi^{-1}(E) \le G$ by the
      subgroup criterion. Now suppose that $E$ is a normal subgroup of $H$. Let
      $g \in G$ and $z \in \varphi^{-1}(E)$. To show that $\varphi^{-1}(E)$ is 
      ...
      $E$. By (Proposition 1 (2) (Pg. 75)), we know that
      $\varphi(g^{-1}) = \varphi(g)^{-1}$. Thus
      ...
      normal in $H$, it follows by (Theorem 6 (5) (Pg. 82)) that
      $\varphi(gzg^{-1}) = \varphi(g)\varphi(z)\varphi(g)^{-1} \in E$; thus
      $gzg^{-1} \in \varphi^{-1}(E)$, and we use (Theorem 6 (5) (Pg. 82)) to
      conclude that $\text{ker}\varphi \trianglelefteq G$. \qed
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%3.1.2%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
